            ...
            children: <Widget>[
              Container(
                ...
                decoration: BoxDecoration(borderRadius: const BorderRadius.all(Radius.circular(40)),
                    image: DecorationImage(image: NetworkImage("http://" + Global.baseUrl + "/storage/" + newItem.item.productDetails['item']['image']))),
              ),
              Expanded(
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: Text(
                          newItem.item.productDetails['item']['name'],
                          maxLines: 2,
                          softWrap: true,
                      ...
                      Text(
                        newItem.item.productDetails['item']['description'],
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          Text(
                            getFormattedCurrency(newItem.item.productDetails['item']['price'].toDouble()),
