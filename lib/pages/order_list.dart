          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                  border: Border(
                    top: BorderSide(width: 2.0, color: Colors.lightGreen.shade300),
                    bottom: BorderSide(width: 2.0, color: Colors.lightGreen.shade300),
                    left: BorderSide(width: 1.0, color: Colors.lightGreen.shade300),
                    right: BorderSide(width: 1.0, color: Colors.lightGreen.shade300),
                  )),
              child: Column(
                children: [
                  Row(
